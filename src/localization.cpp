...
double delta_x = 0.4 ;
double delta_y = 0.2 ;
double delta_z = 0.1914 ;
double delta_w = 0.25 * M_PI ;
...
void MicvisionLocalization::scoreLaserScanSamples() {
  ...
  init_pose.pose.pose.position.x = x - delta_x ;
  init_pose.pose.pose.position.y = y - delta_y ;
  init_pose.pose.pose.position.z = 0 ;

  init_pose.pose.pose.orientation =
      tf::createQuaternionMsgFromYaw(M_PI - best_angle_ + 0.73);
